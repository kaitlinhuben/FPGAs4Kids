...
Elm.Controller.Controller.make = function (_elm) {
   ...
   gameState) {
      return function () {
         var inputs = userInput.inputBools;
         ...
         var newMouseClicks = updatedGameState.clicks + 1;
...
Elm.Controller.InstantiationHelper.make = function (_elm) {
   ...
   logicString) {
      ...
      "inputLogic") ? $Model$Model.inputOffName : _U.eq(status,
      true) && _U.eq(logicString,
   ...
   var initGate = function (jsonPort) {
      return {_: {}
             ,gateType: _U.eq(jsonPort.gateType,
             "InputGate") ? $Model$Model.InputGate : _U.eq(jsonPort.gateType,
             "NormalGate") ? $Model$Model.NormalGate : _U.eq(jsonPort.gateType,
...
Elm.Level_02 = Elm.Level_02 || {};
Elm.Level_02.make = function (_elm) {
   "use strict";
   _elm.Level_02 = _elm.Level_02 || {};
   if (_elm.Level_02.values)
   return _elm.Level_02.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var outputGate = $Controller$InstantiationHelper.initGate(outPort);
   var andPort = _P.portIn("andPort",
   function (v) {
      return typeof v === "object" && "name" in v && "gateType" in v && "status" in v && "inputs" in v && "logic" in v && "location" in v && "imgSize" in v ? {_: {}
                                                                                                                                                              ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _U.badPort("a string",
                                                                                                                                                              v.name)
   ...
   var andGate = $Controller$InstantiationHelper.initGate(andPort);
   var inPort2 = _P.portIn("inPort2",
   function (v) {
      return typeof v === "object" && "name" in v && "gateType" in v && "status" in v && "inputs" in v && "logic" in v && "location" in v && "imgSize" in v ? {_: {}
                                                                                                                                                              ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _U.badPort("a string",
                                                                                                                                                              v.name)
   ...
   var inputGate2 = $Controller$InstantiationHelper.initGate(inPort2);
   var inputChannel2 = $Signal.channel(inputGate2.status);
   var inPort1 = _P.portIn("inPort1",
   function (v) {
      return typeof v === "object" && "name" in v && "gateType" in v && "status" in v && "inputs" in v && "logic" in v && "location" in v && "imgSize" in v ? {_: {}
                                                                                                                                                              ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _U.badPort("a string",
                                                                                                                                                              v.name)
   ...
   var inputGate1 = $Controller$InstantiationHelper.initGate(inPort1);
...
Elm.Model.Model.make = function (_elm) {
   ...
   imgPath,
   "output-bad.png");
   var restartName = A2($Basics._op["++"],
   imgPath,
   "restart.png");
   var nextLevelBtn = A2($Basics._op["++"],
   imgPath,
   "next-level.png");
   var nextLevelNotYetBtn = A2($Basics._op["++"],
   imgPath,
   "next-level-not-yet.png");
   ...
   _elm.Model.Model.values = {_op: _op
                             ...
                             ,nextLevelNotYetBtn: nextLevelNotYetBtn
...
Elm.View.View.make = function (_elm) {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 circuitElement);
                 return _U.eq(gameState.completed,
                 false) ? circuitContainer : function () {
                    ...
                    _L.fromArray([]))]));
                    var levelNextButton = A3($Html.toElement,
                    50,
                    50,
                    nextBtnHTML);
                    var parText = $Text.centered(A2($Text.height,
                    20,
                    $Text.fromString(_U.cmp(gameState.clicks,
                    gameState.clicksPar) < 1 ? "You were at or under par. Good job!" : "You were above par; give it another try.")));
                    var completedText = $Text.centered(A2($Text.height,
                    40,
                    $Text.fromString("You completed the level!")));
                    return A2($Graphics$Element.flow,
                    $Graphics$Element.down,
                    _L.fromArray([A2($Graphics$Element.flow,
                                 $Graphics$Element.right,
                                 _L.fromArray([completedText
                                              ,levelNextButton]))
                                 ,parText
                                 ,circuitContainer]));
                 }();
   ...
   gameState) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var parText = $Text.plainText(A2($Basics._op["++"],
                 "Par: ",
                 $Basics.toString(gameState.clicksPar)));
   ...
   gameState) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var upperBarHeight = 50;
                 var mainHeight = _v15._1 - upperBarHeight;
                 var mainContent = A2(drawMainContent,
                 {ctor: "_Tuple2"
                 ,_0: _v15._0
                 ,_1: mainHeight},
                 gameState);
                 var upperBar = A2(drawNavBar,
                 {ctor: "_Tuple2"
                 ,_0: _v15._0
                 ,_1: upperBarHeight},
                 gameState);
